    ...
    <section id="hero-section">
        <div class="container">
            <div class="heading text-center">
                <h1>
                    Start your business with<br> confidence
                </h1>
                <p>
            ...
            <div class="row ">
                {{-- <div class="dropdown-container d-flex justify-content-evenly flex-row">
                    <div class="dropdown">
                        <select class="dropdown_filter_btn" aria-label="Default select example">
                            <option selected>Open this select menu <i class="bi bi-caret-left"></i></option>
                            <option class="red" value="1">One</option>
                        ...
                        <div class="card-body d-flex flex-column align-items-center">
                            ...
                            <div class="mb-3 image-container">
                                <img class="mb-3 mx-auto" width="160px" height="160px"
                                    src="{{ asset('Frontend/img/rocket.png') }}" alt="rocket.png">
                            </div>
                            <h2 class="mb-3 text-center price "> $ 500</h2>
                            <p class="text-center description" style="margin-bottom: 24px;">One time transparent payment
                            </p>
                            <a href="" class="btn get_start get_start_package btnActivePlatinum" data-package="Platinum">
                            ...
                            <div class="benefit--wrapper">
                                ...
                                <ul class="benefits-list">
                                    ...
                                    <li> <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                        ...
                                        <button class="btn get_start get_start_package btnActivePlatinum" data-package="Platinum">
